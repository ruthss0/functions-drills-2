...
//     evenNumbers.push(mixedNumbers[i])
//   }
// }
////////// PROBLEM 2 //////////
// Do not edit the code below.
...
// CODE HERE
 ...
 const totalPopulations = populations.reduce((acc,population) => acc + population);

// const totalPopulations = populations.reduce(function(acc,population){
...
// CODE HERE
const bobsTotal = purchases.filter(purchase => purchase.owner === 'Bob').reduce((acc, purchase) => acc + purchase.price, 0);
